...
subsets_BPS <- read_csv("~/Desktop/Hot plate assay paper/Data analysis/BPS_subsets_filtered.csv")
RHP_BPS_control_raw_data <- read_excel("~/Desktop/Cannevert /British Pharmacological Society/BPS abstract 2018/BPS 2018 presentation/BPS control raw data files/RHP BPS control raw data.xlsx")
SHP_BPS_control_raw_data_ <- read_excel("~/Desktop/Cannevert /British Pharmacological Society/BPS abstract 2018/BPS 2018 presentation/BPS control raw data files/SHP BPS control raw data .xlsx")
BPS_SHP_THC_DR_data <- read_excel("~/Desktop/Cannevert /British Pharmacological Society/BPS abstract 2018/BPS 2018 presentation/Excel files/BPS SHP THC DR data.xlsx")
BPS_RHP_THC_DR <- read_excel("~/Desktop/Cannevert /British Pharmacological Society/BPS abstract 2018/BPS 2018 presentation/Excel files/BPS RHP THC DR.xlsx")
BPS_morphine_DR_data <- read_excel("~/Desktop/Cannevert /British Pharmacological Society/BPS abstract 2018/BPS 2018 presentation/Excel files/BPS morphine DR data.xlsx")
BPS_G_power_plots_copy <- read_excel("~/Desktop/Cannevert /British Pharmacological Society/BPS abstract 2018/BPS 2018 presentation/Excel files/BPS G_power plots copy.xlsx")
